...
<head>
    ...
    <title>Learners' Space | TSS</title>
...
<!--/Navbar-->
    ...
    <div class="top text-center">
        <h2>Technical Summer School</h2>
        <h6>An integral part of Learners' Space where one can learn and choose from an assortment of courses which
            develop
            some of the necessary applied skills required to build a strong technical profile.</h6>
    </div>


    <?php
        include 'config/dbconnect.php';
        $query = "SELECT * FROM learnerspace2024_courses WHERE course_type='TSS'";
