...
<body>
    ...
    <div class="card1">
      ...
      <div class="back">
      <a class="btn btn-outline-light  mx-2 my-md-0 my-1 dotted-border" style="width:50%;height:7%" href="tss.php">View Project<i class="fas fa-home"></i></a>
      </div>
    </div>
    <div class="card2">
      <div class="front">
      ...
      <div class="back">
      <a class="btn btn-outline-light  mx-2 my-md-0 my-1 dotted-border" style="width:50%;height:7% " href="ntss.php">View Project <i class="fas fa-home"></i></a>
      </div>
    </div>
  </div>
    </section>
